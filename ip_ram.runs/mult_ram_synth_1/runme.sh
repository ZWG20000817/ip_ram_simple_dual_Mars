...
HD_PWD='D:/work/ESLAS_prj/LAB_BRAM/ip_ram/ip_ram.runs/mult_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_ram.tcl
